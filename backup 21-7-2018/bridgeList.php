...
<br>
  ...
  <button type="w3-button" id="testbut" name="markLo" onclick="getLocation();" class="w3-xxlarge w3-teal" autofocus >Mark where I am</button><br>
	...
	$result = $con->query($sql);
		...
		echo " Use Search to find any available bridge.";
		    ...
		    while($row = $result->fetch_assoc()) {
				    ...
				    //echo '<td><a href="padlockaddval.php?id=' . $row['plbid'] . '"  title="Will need a padlock key">Add a padlock</a></td>';
				    echo '<td><a href="pladd.html?id=' . $row['plbid'] . '"  title="Will need a padlock key">Add a padlock</a></td>';				    
